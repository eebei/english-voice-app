...
- DREの現行公式機能・料金とPITWALLの8/9〜8/14実測原価を比較した正本は `docs/DRE_OMORAY_COMPARISON_20260815.md`。DREは単なる反射スポッターではなく広い決定論的戦略機能を持つ。PITWALLの差別化は、会話による計画変更、デブリーフ、人格、継続するドライバー記憶に置く。
